...
const ConnectOverlay = ({
  connectionState, error, statusMessage, connectProgress, onConnect,
}) => {
      ...
      <div className="flex flex-col items-center gap-3">
        ...
        {!connecting && (
          <div className="flex items-center gap-2.5 rounded-[20px] px-3 py-1.5 text-xs text-white/50">
            ...
            <span>Device must be online and offroad.</span>
          </div>
        )}
      </div>
    </div>
...
export default PhotoboothVideo;
